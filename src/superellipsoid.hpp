...
class Superellipsoid {
	private:
		...
		static Eigen::Vector2d constraints(Superellipsoid& p1, Superellipsoid& p2, Eigen::Vector4d& Z);

		static Eigen::Matrix4d J_matrix(Superellipsoid& p1, Superellipsoid& p2, Eigen::Vector4d& Z);

		static Eigen::Vector3d phi(Superellipsoid& p1, Superellipsoid& p2, Eigen::Vector4d& Z);
